...
if ( ! function_exists( 'estore_woocommerce_cart_link_fragment' ) ) {
	...
	function estore_woocommerce_cart_link() {
		?>
		<a class="logo_number cart-contents w3view-cart" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'estore' ); ?>">
		
			<i class="nut-icon icons-number fa fa-cart-arrow-down" aria-hidden="true"></i>
			<span class="quantity count"><?php echo wp_kses_data( WC()->cart->get_cart_contents_count() ) ;?></span>
